...
export class ref_action extends Model<ref_actionAttributes, ref_actionCreationAttributes> implements ref_actionAttributes {
  raction_id!: number;
  raction_name?: string;
  raction_label?: string;

  // ref_action hasMany entity_stage via raction_id
  ...
  // ref_action hasMany ref_stage_action via raction_id
